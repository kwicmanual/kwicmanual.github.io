...
<!-- ---
title: "모니터링 장애대응 매뉴얼" #Getting started with the Documentation Theme for Jekyll"
keywords: index, manual
# tags: [getting_started]
sidebar: manual_sidebar
permalink: index.html
summary: 스크래핑팀에서 진행하는 장애대응 매뉴얼을 설명합니다.
--- -->
...
* [Install Jekyll on Mac][manual_install_jekyll_on_mac]
* [Install Jekyll on Windows][manual_install_jekyll_on_windows]
...
<span class="red">sidebar: manual_sidebar</span>
permalink: manual_alerts
---
</pre>

The `sidebar: manual_sidebar` refers to the \_data/sidebars/manual_sidebar.yml file.
...
This would load the `manual_sidebar` for each file in **pages/manual**. You could set different defaults for different path scopes.

For more detail on the sidebar, see [Sidebar navigation][manual_sidebar_navigation].
...
The sidebar data file uses a specific YAML syntax that you must follow. Follow the sample pattern shown in the theme, specically looking at `manual_sidebar.yml` as an example: Here's a code sample showing all levels:
...
- title: sidebar
  ...
  - title: Release Notes
    ...
    - title: 6.0 Release notes
      url: /manual_release_notes_60.html
      output: web, pdf

    - title: 5.0 Release notes
      url: /manual_release_notes_50.html
      output: web, pdf
  ...
  - title: Tag archives
    ...
    - title: Tag archives overview
      url: /manual_tag_archives_overview.html
      output: web
...
The YAML syntax depends on exact spacing, so make sure you follow the pattern shown in the sample sidebars. See my [YAML tutorial](manual_yaml_tutorial) for more details about how YAML works.

{% include note.html content="If you have just one character of spacing off, Jekyll won't build due to the YAML syntax error. You'll see an error message in your console that says \"Error ... did not find expected key while parsing a block mapping at line 22 column 5. Error: Run jekyll build --trace for more information.\" If you encounter this, it usually refers to incorrect indentation or spacing in the YAML file. See the example manual_sidebar.yml file to see where your formatting went wrong." %}
...
- title: sidebar
  ...
  - title: Installation
    ...
    - title: About Ruby, Gems, Bundler, etc.
      url: /manual_about_ruby_gems_etc.html
      output: web, pdf

    - title: Install Jekyll on Mac
      url: /manual_install_jekyll_on_mac.html
      output: web, pdf

    - title: Install Jekyll on Windows
      url: /manual_install_jekyll_on_windows.html
      output: web, pdf
```
...
For more detail on the sidebar, see [Sidebar navigation][manual_sidebar_navigation] and [YAML tutorial][manual_yaml_tutorial].
...
For more detail, see [Pages][manual_pages].

## Where to store your documentation topics

You can store your files for each product inside subfolders following the pattern shown in the theme. For example, product1, manual2, etc, can be stored in their own subfolders inside the \_pages directory. Inside \_pages, you can store your topics inside sub-subfolders or sub-sub-folders to your heart's content. When Jekyll builds your site, it will pull the topics into the root directory and use the permalink for the URL.

Note that product1, manual2, and manual are all just sample content to demonstrate how to add multiple products into the theme. You can freely delete that content.

For more information, see [Pages][manual_pages] and [Posts][manual_posts].
...
See the section on [Generating PDFs][manual_generating_pdfs] for more details about setting the theme up for this output.
...
See [Posts][manual_posts] for more information.
...
If you want to use an automated system for managing links, see [Automated Links][manual_hyperlinks.html#automatedlinks]. This approach automatically creates a list of Markdown references to simplify linking.
